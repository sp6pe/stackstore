...
describe('User model', function () {
    ...
    it('should have new user', function () {
        var user = new User({email: "jai@jai.jai", password: "test", firstName: "Franklin", lastName: "Gustavo", photoUrl:"something", isAdmin: true, isProduct: false});
       // console.log(user);
        expect(user.email).to.equal('jai@jai.jai');
    });

    it('should cause error if something required is missing', function(done) {
        var user = new User({password: "test", firstName: "Franklin", lastName: "Gustavo", photoUrl:"something", isAdmin: true, isProduct: false});
        //console.log(user);
